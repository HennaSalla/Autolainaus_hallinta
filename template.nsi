...
# REPLACE entries between << and >> your apllication things
...
Section "<<APPLICATION NAME>>" SecProgram
  ...
  # Create uninstaller
  WriteUninstaller "$INSTDIR\<<UNINISTALLER NAME>>.exe"
...
# Descriptions
  ...
  LangString DESC_SecProgram ${LANG_ENGLISH} "<<APP DESKRIPTION IN ENGLISH>>"
