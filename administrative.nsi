...
# General
  ...
  InstallDir "$PROGRAMFILES\Autolainaushallinta"
...
Section "Autolainaussovellus hallinta" SecProgram
  ...
  # READ FILES RECURSIVLEY FROM DITRIBUTION FOLDER CREATED BY PYINSTALLER
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuFolder\Autolainaushallinta.lnk" "$INSTDIR\administrative.exe"
    CreateShortcut "$SMPROGRAMS\$StartMenuFolder\UninstallAutolainaushallinta.lnk" "$INSTDIR\UninstallAutolainaushallinta.exe"
...
# Descriptions
  ...
  LangString DESC_SecProgram ${LANG_ENGLISH} "A program to administer vehicles and borrowers"
...
Section "Uninstall"
  ...
  Delete "$SMPROGRAMS\$StartMenuFolder\UninstallAutolainaushallinta.lnk"
